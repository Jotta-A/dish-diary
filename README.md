...
DishDiary é um projeto de uma aplicação web inspirada no Letterboxd, focada na avaliação e organização de receitas culinarias digitais.
O sistema permite que usuários listem, atribuam notas e escrevam comentários sobre receitas, criando um histórico pessoal com experiências de suas comidas favoritas.
...
- **API Publica**
    - [Recipe API](https://api-ninjas.com/api/recipe). - Base de dados para receitas e ingredientes. 
